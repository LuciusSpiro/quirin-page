...
const bilder: GalerieBild[] = [
  ...
  { id: 'g7', alt: 'Wappen Trident', kategorie: 'Regionen', breite: 'normal', placeholder: 'linear-gradient(135deg, #081420, #0c1828)', src: '/images/wappen-trident.png' },
  { id: 'g8', alt: 'Wappen Nebelwacht', kategorie: 'Regionen', breite: 'normal', placeholder: 'linear-gradient(135deg, #08101a, #0c1420)', src: '/images/wappen-nebelwacht.png' },
